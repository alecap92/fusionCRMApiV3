...
exports.getRecalculationStatus = exports.recalculateContactScores = exports.recalculateScores = exports.deleteScoringRule = exports.updateScoringRule = exports.createScoringRule = exports.getScoringRuleById = exports.getAllScoringRules = void 0;
const ScoringRuleModel_1 = __importDefault(require("../../models/ScoringRuleModel"));
const leadScoring_1 = require("../../utils/leadScoring");
 ...
 */
const getAllScoringRules = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const rules = yield ScoringRuleModel_1.default.find({ organizationId });
        res.json(rules);
    }
    catch (error) {
...
exports.getAllScoringRules = getAllScoringRules;
/**
 * Obtener una regla de puntuación específica
 */
const getScoringRuleById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { organizationId } = req.user || {};
        if (!organizationId) {
        ...
        const rule = yield ScoringRuleModel_1.default.findOne({
            _id: id,
            organizationId,
        });
        if (!rule) {
...
exports.getScoringRuleById = getScoringRuleById;
/**
 * Crear una nueva regla de puntuación
 */
const createScoringRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { organizationId } = req.user || {};
        if (!organizationId) {
            return res.status(400).json({
        ...
        // Crear nueva regla
        const newRule = new ScoringRuleModel_1.default({
            organizationId,
            name,
            description,
            isActive: true,
...
exports.createScoringRule = createScoringRule;
/**
 * Actualizar una regla de puntuación existente
 */
const updateScoringRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { organizationId } = req.user || {};
        if (!organizationId) {
        ...
        const existingRule = yield ScoringRuleModel_1.default.findOne({
            _id: id,
            organizationId,
        });
        if (!existingRule) {
        ...
        if (rules && Array.isArray(rules))
            existingRule.rules = rules;
        existingRule.updatedAt = new Date();
        yield existingRule.save();
        res.json({
            success: true,
...
exports.updateScoringRule = updateScoringRule;
/**
 * Eliminar una regla de puntuación
 */
const deleteScoringRule = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { organizationId } = req.user || {};
        if (!organizationId) {
        ...
        const result = yield ScoringRuleModel_1.default.deleteOne({
            _id: id,
            organizationId,
        });
...
exports.deleteScoringRule = deleteScoringRule;
/**
 ...
 */
const recalculateScores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { organizationId } = req.user || {};
        if (!organizationId) {
            return res.status(400).json({
        ...
        console.log(`[JobID: ${jobId}] Iniciando recálculo de puntajes para organización ${organizationId}`);
        // Iniciar el proceso de recálculo sin esperar a que termine
        (0, leadScoring_1.recalculateAllLeadScores)(organizationId)
            .then(() => {
            const endTime = Date.now();
            const executionTime = endTime - recalculationJobs.get(jobId).startTime;
            // Actualizar el estado del trabajo
            recalculationJobs.set(jobId, Object.assign(Object.assign({}, recalculationJobs.get(jobId)), { status: "completed", endTime }));
            console.log(`[JobID: ${jobId}] Recálculo completado en ${executionTime}ms`);
        })
            .catch((error) => {
            // Actualizar el estado del trabajo con el error
            recalculationJobs.set(jobId, Object.assign(Object.assign({}, recalculationJobs.get(jobId)), { status: "failed", endTime: Date.now(), error: error.message }));
...
exports.recalculateScores = recalculateScores;
/**
 * Recalcula los puntajes de un contacto específico
 */
const recalculateContactScores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Iniciar el proceso de recálculo sin esperar a que termine
        (0, leadScoring_1.recalculateContactScore)(contactId, organizationId)
            .then((score) => {
            res.json({
                success: true,
...
exports.recalculateContactScores = recalculateContactScores;
/**
 * Obtiene el estado del trabajo de recálculo de puntajes
 */
const getRecalculationStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getRecalculationStatus = getRecalculationStatus;
