...
import InvoiceConfiguration, { IInvoiceConfiguration } from "../../models/InvoiceConfiguration";
import { IApiInvoice, IApiCreditNote } from "../../types/invoices";
...
export const createConfiguration = async (organizationId:string) => {
    try {
      ...
      const data:IInvoiceConfiguration | null = await InvoiceConfiguration.findOne({
        organizationId,
      });
      ...
      const response = await axios.post(
        `${process.env.FACTURACION_API_URL}/ubl2.1/config/${data.companyInfo.nit}/${data.companyInfo.dv}`,
        body
      );
  
      // save token to database
      await InvoiceConfiguration.updateOne(
        {
          organizationId,
        },
  ...
  export const softwareConfiguration = async (organizationId:string) => {
    try {
      ...
      const response = await axios.put(
        `${process.env.FACTURACION_API_URL}/ubl2.1/config/software`,
        body,
        {
          headers: {
  ...
  export const certificateUpload = async (organizationId:string) => {
    try {
      if (!organizationId) {
        throw new Error("Organization ID is required");
      }
      ...
      const response = await axios.put(
        `${process.env.FACTURACION_API_URL}/ubl2.1/config/certificate`,
        body,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  export const configResolution = async (organizationId:string) => {
    try {
      if (!organizationId) {
        throw new Error("Organization ID is required");
      }
      ...
      const response = await axios.put(
        `${process.env.FACTURACION_API_URL}/ubl2.1/config/resolution`,
        body,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  export const changeEnvironment = async (organizationId:string) => {
    try {
      if (!organizationId) {
        throw new Error("Organization ID is required");
      }
      ...
      const response = await axios.put(
        `${process.env.FACTURACION_API_URL}/ubl2.1/config/environment`,
        body,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  export const getTechnicalKey = async (organizationId:string) => {
    try {
      if (!organizationId) {
        throw new Error("Organization ID is required");
      }
      ...
      const response = await axios.post(`${process.env.FACTURACION_API_URL}/ubl2.1/numbering-range`, body, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
      ...
      await axios.put(`${process.env.FACTURACION_API_URL}/ubl2.1/config/resolution`, form, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
  ...
  export const createInvoiceInApi = async (invoice:IApiInvoice, organizationId:string) => {
    try {
      const data:IInvoiceConfiguration | null = await InvoiceConfiguration.findOne({
        organizationId,
      });
      ...
      const response = await axios.post(`${process.env.FACTURACION_API_URL}/ubl2.1/invoice`, invoice, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
  ...
  export const getInvoicesFromApi = async (organizationId:string) => {
    try {
      ...
      const response = await axios.get(`${process.env.FACTURACION_API_URL}/information/${data.companyInfo.nit}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
  ...
  export const createCreditNoteInApi = async (creditNote:IApiCreditNote, organizationId:string) => {
    try {
      const data:IInvoiceConfiguration | null = await InvoiceConfiguration.findOne({
        organizationId,
      });
      ...
      const response = await axios.post(`${process.env.FACTURACION_API_URL}/ubl2.1/credit-note`, creditNote, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
  ...
  export const downloadXmlInvoice = async (invoice:any, organizationId:string) => {
    try {
      ...
      const response = await axios.get(`${process.env.FACTURACION_API_URL}/invoice/${idNumber}/FES-${prefix}${invoiceNumber}.xml`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
  ...
  export const downloadPdfInvoice = async (invoice:any, organizationId:string) => {
    try {
      const data:IInvoiceConfiguration | null = await InvoiceConfiguration.findOne({
        organizationId,
      });
      ...
      const response = await axios.get(`${process.env.FACTURACION_API_URL}/invoice/${idNumber}/FES-${prefix}${invoiceNumber}.pdf`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${data.token}`,
        },
